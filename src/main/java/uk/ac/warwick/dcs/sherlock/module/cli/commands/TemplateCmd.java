...
public class TemplateCmd implements Runnable {
    ...
    // This code is redundant as it is identical in functionality to the view template details command
    /**
     * The View Parameters command for the Template command. Outputs the parameters
     *  for a template's detectors, as well as their values. 
     * Command: template viewParameters -t=[template]
     */
    ...
    // static class viewParameters implements Runnable {
    ...
    //     /**
    //      * Outputs the parameters for a template's detectors, as well as their values.
    //      */
    //     @Override
    //     public void run() {
    ...
    //                     //find all set parameters for that detector
    ...
    //                     //and then assign them either as pre or post processing parameters
    ...
    //                     //then find all possible parameters for the detector
    //                     try{
    ...
    //                         //then print the parameter, either the assigned value if we found one, or the default value
